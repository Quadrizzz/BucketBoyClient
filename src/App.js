...
function App() {
  ...
  const handleTweetClick = ()=>{
    window.open(`https://twitter.com/intent/tweet?url=${twit}&hashtags=BucketboyNFT`,'_blank')
  }
  ...
  return (
    <div className="App" style={{height:height + 'px'}}>
      ...
      <div className='Forms'>
        ...
        <h3>The below steps are important to authenticate users in our discord community.<br></br><br></br>
            - Retweet and Quote the pinned tweet on our official twitter account @BucketboyNFT with the #BucketboyNFT<br></br><br></br>
            - Follow @BucketboyNFT<br></br><br></br>
